  ...
  return (
    <div className="container py-12 md:py-24">
      ...
      <div className="max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-300 space-y-6">
        <p>
          Na JuridiDocs, a privacidade dos nossos usuários é de extrema importância. Esta política de privacidade
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Para proteger os direitos, propriedade ou segurança da JuridiDocs, nossos usuários ou o público.</li>
        </ul>
        <h2 className="text-2xl font-bold gradient-blue-text dark:gradient-blue-text-dark mt-8 mb-4">
          Segurança dos Dados
        </h2>
        ...
        <h2 className="text-2xl font-bold gradient-blue-text dark:gradient-blue-text-dark mt-8 mb-4">Seus Direitos</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold gradient-blue-text dark:gradient-blue-text-dark mt-8 mb-4">Contato</h2>
        <p>
