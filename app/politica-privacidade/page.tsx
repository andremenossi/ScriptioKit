export default function PrivacyPolicyPage() {
  return (
    <div className="container py-12 md:py-24">
      <h1 className="text-4xl font-bold text-center mb-8 text-sk-blue-DEFAULT">Política de Privacidade</h1>
      <div className="max-w-3xl mx-auto text-lg text-sk-gray-600 dark:text-sk-gray-400 space-y-6">
        <p>
          Na ScriptioKit, a privacidade dos nossos usuários é de extrema importância. Esta política de privacidade
        ...
        <p>
          ...
          e-mail:
          <a href="mailto:contato@scriptiokit.com.br" className="text-sk-blue-DEFAULT hover:underline ml-1">
