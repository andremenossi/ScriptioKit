...
export default function FAQPage() {
  return (
    <div className="container py-12 md:py-24">
      ...
      <div className="max-w-3xl mx-auto border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white dark:bg-gray-800">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="border-b border-gray-200 dark:border-gray-700">
            ...
            <AccordionTrigger className="text-lg font-semibold gradient-blue-text dark:gradient-blue-text-dark hover:no-underline px-6 py-4 transition-colors hover:bg-blue-50 dark:hover:bg-blue-900/20">
              Os modelos são válidos legalmente?
            </AccordionTrigger>
            <AccordionContent className="text-gray-600 dark:text-gray-300 text-base px-6 pb-4">
